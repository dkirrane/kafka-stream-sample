...
//        if(!StringUtils.isBlank(kafkaSecrets.getCaCert())) {
...
//        props.put(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, TlsUtil.TRUSTSTORE_PATH);
//        props.put(SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG, TlsUtil.PASSWORD);
